        ...
        <div className="flex justify-end  w-5/6">
          <form>
            <div className="relative flex">
              ...
              <button
                type="submit"
                className="inline-flex bg-transparent hover:bg-blue-900 dark:text-blue-900 font-bold hover:text-white border dark:border-blue-900 hover:border-transparent rounded-sm  w-[71px] h-9 px-3 py-5 items-center justify-center"
              >
                Search
              </button>
            </div>
          ...
          {isLoggedIn ? (
            ...
            <Link to="/login">
              <button className="ml-4 me-2 py-2 px-3 bg-blue-900 text-white rounded-lg">
                Login
              </button>
            </Link>
          )}
